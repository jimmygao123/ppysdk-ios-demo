...
public class NetworkUtils {
    ...
    public static boolean isMobileNetwork(Context context) {
        return isNetworkAvailable(context) &&
                (ConnectivityManager.TYPE_MOBILE == getNetworkType(context));
    }
    ...
    public static boolean isWifiNetwork(Context context) {
        return isNetworkAvailable(context) &&
                (ConnectivityManager.TYPE_WIFI == getNetworkType(context));
    }
    ...
    public static boolean isWifiOrEthernetNetwork(Context context) {
        return isNetworkAvailable(context)
                && (ConnectivityManager.TYPE_WIFI == getNetworkType(context)
                || ConnectivityManager.TYPE_ETHERNET == getNetworkType(context));
    }
...
//                        Log.d(TAG,"===>代理：" + c.getString(c.getColumnIndex("proxy")));
